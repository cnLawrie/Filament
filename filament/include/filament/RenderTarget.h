...
public:
    ...
    //! Use Builder to construct an RenderTarget object instance
    ...
    /**
     * Get the texture set on the given attachment point
     ...
     * @param attachment Attachment point
     * @return A texture layer. This in only relevant if the attachment's texture is a 3D texture.
     */
